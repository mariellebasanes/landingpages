...
<section class="section-padding bg-networkmap">
  <div class="container container-xxl">
    <div class="card bg-white bg-opacity-10 border-0 rounded-4 overflow-hidden position-relative">
      ...
      <div class="card-body p-15 p-lg-20 text-center position-relative z-index-1">
        <h2 class="fs-3x text-white mb-8">Ready to Map Your Future?</h2>
        <p class="fs-3 text-white opacity-75 mb-10 mw-800px mx-auto">
